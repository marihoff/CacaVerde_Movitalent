...
Repositório do \*\*Time Monza\*\* para o projeto Caça Verde.
...
\- Catalogar itens com múltiplas fotos

\- Geolocalização

\- Sistema de pontos (parcial)

\- Admin (adicionar/remover pontos, banir)
...
\- Integração com Time Verona (coleta)

\- Integração com Time Roma (admin completo)
...
Desenvolvido para o projeto Caça Verde - FIAP 2024/2025
